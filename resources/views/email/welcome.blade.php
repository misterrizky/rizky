    ...
    <body style="background: #F9F9F9;">
        <div style="background-color:#F9F9F9;">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="width:138px;">
                                                                    <a href="https://rizky-ramadhan.com/" target="_blank">
                                                                        <img alt="" title="Rizky Ramadhan" height="38px" src="https://cdn.rizky-ramadhan.com/images/logo.png" style="border:none;border-radius:;display:block;outline:none;text-decoration:none;width:100%;height:38px;" width="138">
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
            ...
            <div style="max-width:640px;margin:0 auto;box-shadow:0px 1px 5px rgba(0,0,0,0.1);border-radius:4px;overflow:hidden">
                <div style="margin:0px auto;max-width:640px;background:#7289DA url(https://cdn.rizky-ramadhan.com/images/email/welcome_header.png) top center / cover no-repeat;">
                    <table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:#7289DA url(https://cdn.rizky-ramadhan.com/images/email/welcome_header.png) top center / cover no-repeat;" align="center" border="0" background="https://cdn.rizky-ramadhan.com/images/email/welcome_header.png">
                        <tbody>
                            <tr>
                                                ...
                                                <tr>
                                                    <td style="word-break:break-word;font-size:0px;padding:0px 0px 20px;" align="left">
                                                        <div style="cursor:auto;color:#737F8D;font-family:Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-size:16px;line-height:24px;text-align:left;">
                                                            <p>
                                                                <img src="https://cdn.rizky-ramadhan.com/images/email/welcome_bg.png" alt="Party Wumpus" title="None" width="500" style="height: auto;">
                                                            </p>
                                                            ...
                                                            <p>
                                                                Wowwee! Thanks for registering an account with Rizky Ramadhan! You're the coolest person in all the land (and I've met a lot of really cool people).
                                                            </p>
                                                            <p>
                                            ...
                                            <tr>
                                                <td style="word-break:break-word;font-size:0px;padding:0px;" align="center">
                                                    <div style="cursor:auto;color:#99AAB5;font-family:Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-size:12px;line-height:24px;text-align:center;">
                                                        Sent by Rizky Ramadhan • 
                                                        <a href="https://blog.rizky-ramadhan.com/" style="color:#1EB0F4;text-decoration:none;" target="_blank">
                                                            check our blog
                                                        </a> • 
                                                        <a href="https://instagram.com/mister.rizky" style="color:#1EB0F4;text-decoration:none;" target="_blank">
                                                            @mister.rizky
                                                        </a>
                                                    </div>
                                                </td>
